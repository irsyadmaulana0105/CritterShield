...
function ambil_judul($id_tulisan){
    global $koneksi;
    $sql1   = "select * from blogs where id = '$id_tulisan'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $text   = $r1['judul'];
    return $text;
...
function buat_link_blogs($id){
    global $koneksi;
    $sql1    = "select * from blogs where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $isi = bersihkan_judul($r1['isi']);
    // http://localhost/website-company-profile/halaman.php/8/judul
    return url_dasar()."/blogs.php/$id/$isi";
}


// about us fungsion

function about_foto($id){
    global $koneksi;
    ...
    if($foto){
        ...
        return 'about_default_picture.png';
    }
}

function buat_link_about($id){
    global $koneksi;
    $sql1    = "select * from about where id = '$id'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $isi = bersihkan_judul($r1['isi']);
    // http://localhost/website-company-profile/halaman.php/8/judul
    return url_dasar()."/about.php/$id/$isi";
}
...
function ambil_isi_blogs($id_tulisan){
    global $koneksi;
    $sql1   = "select * from blogs where id = '$id_tulisan'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
...
function ambil_isi_about($id_tulisan){
    global $koneksi;
    $sql1   = "select * from about where id = '$id_tulisan'";
    $q1     = mysqli_query($koneksi,$sql1);
    $r1     = mysqli_fetch_array($q1);
    $text   = strip_tags($r1['isi']);
    return $text;
...
function kirim_email($email_penerima, $nama_penerima, $judul_email, $isi_email){
    ...
    $email_pengirim     = "irsyadmaulana0105@gmail.com";
    ...
    try {
        ...
        $mail->Username   = 'irsyadmaulana0105@gmail.com';                     
        $mail->Password   = 'fhuhouvfwlrfrart';                            //SMTP password
        ...
        return true; // Pengiriman email berhasil
    } catch (Exception $e) {
...
// kirim_email("irsyadmaulana0105@gmail.com", "nama_penerima","ganteng coy","wowwwwwwwwwwwwwwww");