...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "about_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update about set foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into about(foto,isi) values ('$foto_name','$isi')";
        }
...
?>
<div class="container">
<h1>Halaman Admin Input Data About Us</h1>
<div class="mb-3 row">
    <a href="about.php">
        << Kembali ke halaman admin About Us</a>
</div>
<?php
if ($error) {
?>
